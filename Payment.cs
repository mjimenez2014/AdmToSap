...
namespace AdmToSap
{
    ...
    class Transferencia
    {
        public String cuenta { get; set; } // Cuenta de Transferencia
        [DataMember]
        public String totalTrans { get; set; } // Total de la Transferencia
        [DataMember]
        public String fechaTrans { get; set; } // Fecha de la transferencia
        [DataMember]
        public String MemoTrans { get; set; } // Datos adicional de la transferencia
